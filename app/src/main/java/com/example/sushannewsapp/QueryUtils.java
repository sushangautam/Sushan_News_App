...
public class QueryUtils {
    ...
    public static List<Newspaper> fetchNewsData(String requestUrl) {
        ...
        List<Newspaper> newsList = extractFeatureFromJson(jsonResponse);
    ...
    private static List<Newspaper> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                Newspaper news = new Newspaper(Title, category, date, url, author);
